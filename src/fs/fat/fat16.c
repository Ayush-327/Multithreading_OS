...
#define PEACHOS_FAT16_BAD_SECTOR 0xFFFF7
...
struct fat_private
{
    ...
    struct disk_stream* directroy_stream;
};
...
static void fat16_init_private(struct disk* disk, struct fat_private* private)
{
    ...
    private->directroy_stream = diskstreamer_new(disk->id);
}
...
int fat16_get_total_items_for_directory(struct disk* disk, uint32_t directory_start_sector)
{
    ...
    struct disk_stream* stream = fat_private->directroy_stream;
